...
async function concatNonce(/** @type {Uint8Array} */ rawAuthenticatorData, /** @type {Uint8Array} */ rawClientData) {
	...
	data.set(await crypto.subtle.digest("sha-256", rawClientData), rawAuthenticatorData.length);
	return data;
}
...
export async function assertion(a, opts) {
	...
	if (!(await crypto.subtle.verify(algorithm, key, toBuffer(response.signature, "signature"), data))) {
